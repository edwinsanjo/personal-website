    ...
    return (
        <div id='Projects' className='bg-[#009787] h-[200vh] lg:h-[115vh] w-screen'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 place-items-center h-56'>
                ...
                <Link href='https://github.com/edwinsanjo/shopping-website' className='bg-[#127369] h-[11.5rem] mb-10 rounded-[6px] border-2 border-white text-white py-5 px-10'>
                ...
                <Link href='https://github.com/edwinsanjo/Todo-App' className='bg-[#127369] mb-10 h-[11.5rem] rounded-[6px] border-2 border-white text-white py-5 px-10'>
                ...
                <Link href='https://github.com/edwinsanjo/Calculator' className='bg-[#127369] mb-10 h-[11.5rem] rounded-[6px] border-2 border-white text-white py-5 px-10'>
                ...
                <Link href='https://github.com/edwinsanjo/discord.js-v13-command-handler' className='bg-[#127369] h-[11.5rem] mb-10 rounded-[6px] border-2 border-white text-white py-5 px-10'>
